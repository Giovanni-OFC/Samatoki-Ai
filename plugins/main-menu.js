...
“ Hola *%name* soy *Samatoki Ai*, %greeting ”
...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
  try {
    ...
    let pp14 = 'https://qu.ax/obLi.jpg'
    let pp15 = 'https://qu.ax/GnZD.jpg'
    let img = await (await fetch(`https://f.uguu.se/KqlRWapp.jpg`)).buffer()
    await m.react('⭐')
